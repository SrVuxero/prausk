...
@section('content')
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    <div class="card p-8 rounded-md bg-blue-200 shadow-md">
        <div class="card-top flex justify-between items-center">
            ...
            <div class="notif flex items-center gap-1 bg-blue-900 text-white px-3 py-1 text-xs rounded-2xl">
                32%
  ...
  <div class="grid grid-cols-2 gap-4 mt-8">
    <div class="notification bg-gradient-to-r shadow-md p-6 from-blue-800 to-green-950 h-full  rounded-md">
    ...
    <div class="report relative bg-gradient-to-r p-6 shadow-md from-blue-800 to-green-950 h-full rounded-md">
        <div class="wrappers flex gap-8">
