...
<div class="headers flex justify-between">
    ...
    <button id="openaddmodal" class="add-user bg-blue-950 text-white px-3 py-2 rounded-lg flex items-center gap-2">
...
<div class="searchandfilter mt-3 flex items-center gap-3">
    ...
    <div class="filter bg-blue-950 text-white mt-2 p-[11px] rounded-md">
