...
<body class="">
    <div class="container mx-auto flex justify-center">
        ...
        <div class="login-forms mt-12 shadow-lg rounded-lg w-1/3 bg-gradient-to-b from-blue-300 to-blue-200 p-8">
            <div class="admin flex items-center gap-3 font-bold mb-5">
                <h1>Kharaa Kantin</h1>
            </div>

            <form method="POST" action="{{ route('kantin.login.proceed') }}" class="mb-8">
                @csrf
                <div class="user-id">
                    ...
                    <input name="username" id="user-id"
                        ...
                        required type="text" placeholder="Enter Your Username/Email">
                </div>
                <div class="user-password mt-4">
                    <label for="">Password</label>
                    <input name="password" type="password" id="user-password"
                        class="w-full mt-2 px-4 py-2 bg-gray-100 rounded-md focus:outline-none focus:border-[#003034] focus:border-2"
                        required type="text" placeholder="Enter Your Password">
                </div>
